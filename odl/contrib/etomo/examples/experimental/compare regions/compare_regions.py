...
dir_path = os.path.abspath('/home/z/i/zickert/Experimental')
...
reco_path = '/mnt/imagingnas/data/Users/gzickert/TEM/Reconstructions/Experimental/Region3/kaczmarz/'
...
#maxiter = 10001
#
#op_norm = 1.1 * 0.024567062927833495 # 1.1 * odl.power_method_opnorm(forward_op.derivative(reco_space.zero()))
#
#omega = 1 / (op_norm ** 2)
#
