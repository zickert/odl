...
lin_op_adj = forward_op.derivative(reco_space.zero()).adjoint
...
op = odl.BroadcastOperator(lin_op, gradient)
...
l2_norm = odl.solvers.L2NormSquared(lin_op.range).translated(data)
