...
file_path_tiltseries = os.path.join(dir_path, 'tiltseries_perfect_detector_perfect_dqe.mrc')
...
(data-1).show(coords=coords, title='TEM-Simulator data')
(data_from_this_model-1).show(coords=coords, title='data from my op')
(data_from_this_model_lin-1).show(coords=coords, title='data from my lin op')
...
data_zero_tilt = (data-1).asarray()[30,:,:]
data_max_tilt = (data-1).asarray()[60,:,:]
