...
dir_path = os.path.abspath('/home/z/i/zickert/Recos_math_of_ET/Region2/SIRT')

file_path_reco = os.path.join(dir_path, 'FEI_region2_IMOD_SIRT_rec_reg010_cutoff005_iter10.mrc')
...
#p2, p98 = np.percentile(orthoslice, (2, 98))
#orthoslice = exposure.rescale_intensity(orthoslice, in_range=(p2, p98))
