...
dir_path = os.path.abspath('/home/z/i/zickert/Recos_math_of_ET/Region1/Approx inverse')

file_path_reco = os.path.join(dir_path, 'FEI_region1_rec_c_2_g_42_rotated.mrc')
